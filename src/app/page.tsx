...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Alex Riv",
          handle: "@alexriv",
          testimonial: "The visuals are beyond anything I've seen. Simply stellar.",
          rating: 5,
        ...
        },
        {
          name: "Sam K",
          handle: "@samk",
          testimonial: "Fast, sleek, and undeniably premium. My favorite shopping hub.",
          rating: 5,
        ...
        },
        {
          name: "Jordan P",
          handle: "@jordanp",
          testimonial: "The 3D interactions are flawlessly smooth.",
          rating: 5,
        ...
        },
        {
          name: "Casey L",
          handle: "@caseyl",
          testimonial: "A billion-dollar brand experience for sure.",
          rating: 5,
        ...
        },
        {
          name: "Riley M",
          handle: "@rileym",
          testimonial: "Customer service is as fast as their loading times.",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/female-employee-black-suit-looks-thoughtful_114579-15853.jpg",
          alt: "Female employee in black suit",
        },
        {
          src: "http://img.b2bpic.net/free-photo/beautiful-woman-standing-wall_23-2148415941.jpg",
          alt: "Beautiful woman standing next to wall",
        },
        {
          src: "http://img.b2bpic.net/free-photo/transgender-person-wearing-yellow-jacket-standing-sideways_23-2148827063.jpg",
          alt: "Transgender person in yellow jacket",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-girl-white-blazer-sending-kiss_114579-15692.jpg",
          alt: "Young girl in white blazer",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-stylish-woman-posing-fashionable-outfit_23-2149021812.jpg",
          alt: "Stylish woman in fashion outfit",
        },
      ]}
    />
  </div>
      ...
      products={[
        {
          ...
          name: "Neon Kinetic",
          price: "$1,299",
          imageSrc: "http://img.b2bpic.net/free-photo/food-delivery-bag_187299-48705.jpg",
        },
        {
          id: "p2",
          name: "Cyborg Strider",
          price: "$899",
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-background-with-flowing-lines-design_1048-6534.jpg",
        },
        {
          id: "p3",
          name: "Flux Wearable",
          price: "$499",
          imageSrc: "http://img.b2bpic.net/free-vector/realistic-fitness-trackers_52683-36992.jpg",
        },
        {
          id: "p4",
          name: "Quantum Gear",
        ...
        },
        {
          ...
          name: "Hyper Velo",
          price: "$950",
          imageSrc: "http://img.b2bpic.net/free-photo/luxury-3d-product-backdrop-black-with-gold-confetti_53876-103094.jpg",
        },
        {
          id: "p6",
          name: "Neo Pulse",
